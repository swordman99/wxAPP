...
@app.route('/')
def index():
    s1 = '<h1>欢迎！\n这是微信小程序“地学知识竞赛”的后台网站，微信小程序不是APP所以备案时选择的是\n\
    				  “非交互”中的“www服务”，因为后台是根据微信小程序中的openid处理对应信息的，所以\n\
    				  使用浏览器看不到除这段话以外的其他内容！这不是 网站没有打开 ，也不是 网站没有内容 。\n\
    				  如果这样无法审核通过的话，能否请告知应该如何操作？\n\
    				  还有，不知道为什么010-82510330的电话在工作时间也无法打通。</h1>'
