...
def index():
    s1 = '<h>尊敬的警官，您好！</h>'
    s2 = '<h>这是微信小程序“地学知识竞赛”的后台网站，微信小程序不是APP，所以备案时选择的是</h>'
    s3 = '<h>“非交互”中的“www服务”。又因为后台是根据微信小程序中的openid处理对应信息的，所以</h>'
    s4 = '<h>使用浏览器看不到除这段话以外的其他内容！这不是因为 网站没有打开 ，也不是 网站没有内容 。</h>'
    s5 = '<h>如果这样无法审核通过的话，能否麻烦警官在“审核未通过”的原因中告知应该如何操作？</h>'
    s6 = '<h>万分感谢！万分感谢！</h>'
